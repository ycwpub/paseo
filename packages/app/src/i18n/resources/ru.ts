...
export const ru: TranslationResources = {
  ...
  workflows: {
    ...
    nodes: {
      ...
      agent: {
        ...
        lifecycleHint:
          "Определяет, как долго этот узел повторно использует одного агента. Повторные вызовы выполняются последовательно.",
        selectLifecycle: "Выберите жизненный цикл агента",
        lifecycleOptions: {
          workflow: "Весь Workflow",
          workflowDescription:
            "Создать при первом запуске, повторно использовать и освободить после завершения Workflow.",
          for: "Текущий цикл For",
          forDescription:
            "Создать на первой итерации, повторно использовать в текущем цикле For и освободить при выходе.",
          single: "Один запуск",
          singleDescription:
  ...
  sidebar: {
    ...
    workspace: {
      ...
      bulkArchive: {
        select: "Выбрать рабочие пространства",
        selected: "Выбрано: {{count}}",
        cancel: "Отменить выбор",
        title: "Архивировать {{count}} рабочих пространств?",
        message: "Выбранные рабочие пространства будут архивированы и удалены с боковой панели.",
        riskyWorktrees:
          "В {{count}} выбранных worktree есть незафиксированные или неотправленные изменения. Их каталоги могут быть удалены.",
        confirm: "Архивировать выбранные",
        failed: "Не удалось архивировать {{count}} рабочих пространств",
      },
      confirmations: {
  ...
  settings: {
    ...
    project: {
      ...
      memory: {
        ...
        content: {
          title: "Содержимое памяти",
          description:
            "Просматривайте, изменяйте и удаляйте долговременную память этого проекта и его рабочих пространств. Здесь нельзя изменить область памяти.",
          scope: "Область памяти",
          scopes: {
            project: "Текущий проект",
            workspace: "Рабочее пространство",
          },
          selectScope: "Выберите область памяти",
          noScopes: "Нет доступных областей памяти",
          selectWorkspace: "Выберите рабочее пространство",
          noWorkspace: "У этого проекта нет доступных рабочих пространств",
          loading: "Загрузка памяти...",
          empty: "В этой области нет подходящих записей памяти",
          errorTitle: "Не удалось управлять памятью проекта",
          deleteTitle: "Удалить «{{title}}»?",
          deleteDescription: "Эту память и сведения об источнике нельзя будет восстановить.",
