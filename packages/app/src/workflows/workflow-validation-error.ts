...
const STEP_FIELD_LABEL_KEYS = new Map<string, string>([
  ...
  ["module", "workflows.nodes.python.module"],
  ["function", "workflows.nodes.python.function"],
  ...
  ["env", "workflows.nodes.common.environment"],
  ...
  ["breakWhen", "workflows.nodes.for.breakWhen"],
  ["continueWhen", "workflows.nodes.for.continueWhen"],
